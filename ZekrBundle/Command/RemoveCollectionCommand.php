...
class RemoveCollectionCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('zekr:remove-collection')
            ->setDescription('Remove Collection')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if($id) {
            ...
            if($collection) {
                $collectionIndexer = $this->getContainer()->get('search.service')->getIndexer()->getCollectionIndexer();
                $collectionIndexer->delete($collection);
